    ...
    <footer className=" bg-card" style={{background: "linear-gradient(180deg, rgba(0, 0, 0, 0.8) 0%, rgba(0, 0, 0, 0.8) 100%)"}}>
      <div className="section-container py-12">
        ...
        <button
          ...
          className="fixed bottom-24 right-7 z-50 w-12 h-12 bg-gradient-to-r from-[#012b80] via-[#0D89D6] to-[#40F2FF] rounded-full flex items-center justify-center text-white shadow-lg hover:shadow-xl transition-all duration-300 animate-fade-in"
        >
