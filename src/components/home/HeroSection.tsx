...
import fondoVideoMobile from "@/assets/fondo-video-mobile.mp4";
...
const HeroSection = () => {
  ...
  return (
    <section className="min-h-[90vh] md:min-h-screen flex items-start justify-center relative overflow-hidden pt-16 md:pt-20">
      <video autoPlay loop muted playsInline className="absolute inset-0 w-full h-full object-contain md:object-cover z-0 object-center">
        <source src={fondoVideoMobile} type="video/mp4" media="(max-width: 767px)" />
